...
public class OffreDisplayController {
    ...
    private void showOfferDetails(Offre offer) {
        ...
        benefitsHeader.getChildren().addAll(benefitsTitle);
        ...
        for (String benefit : benefits) {
            if (benefit != null && !benefit.trim().isEmpty()) {
                ...
                benefitItem.getChildren().addAll(benefitText);
        ...
        validityHeader.getChildren().addAll(validityTitle);
        ...
        fromBox.getChildren().addAll(fromLabel, fromValue);
        ...
        untilBox.getChildren().addAll(untilLabel, untilValue);

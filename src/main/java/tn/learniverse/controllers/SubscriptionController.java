...
public class SubscriptionController {
    ...
    @FXML private Label totalSubscriptionsText;
    @FXML private Label activeSubscriptionsText;
    @FXML private Label avgDurationText;
    @FXML private Label totalCoursesText;
    ...
    @FXML private Label totalPagesText;

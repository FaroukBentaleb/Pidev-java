...
public class ResultViewController implements Initializable {
    ...
    private VBox createResultCard(Challenge challenge, Submission submission) {
       ...
       VBox contentBox = new VBox();
                ...
                String finalHtmml = CodeHighlighter.addSyntaxHighlighting(tn.learniverse.tools.HtmlDisplayer.createStyledHtml(challengeContent));
        ...
        // User solution section
                ...
                String finalHtmll = CodeHighlighter.addSyntaxHighlighting(tn.learniverse.tools.HtmlDisplayer.createStyledHtml(studentTry));
...
// Use WebView to display HTML formatted corrected code
            ...
            String finalHtml = CodeHighlighter.addSyntaxHighlighting(tn.learniverse.tools.HtmlDisplayer.createStyledHtml(correctedCode));

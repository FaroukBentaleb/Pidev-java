...
public class MyCompetition implements Initializable {
    ...
    private void navigateToResults(Map<Challenge, Submission>a,String z) {
        try {
            ...
            // Set the scene
            Stage stage = (competitionsContainer != null && competitionsContainer.getScene() != null)
                    ? (Stage) competitionsContainer.getScene().getWindow()
                    : (Stage) filterAllBtn.getScene().getWindow();

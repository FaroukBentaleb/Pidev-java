    ...
    private void handleNext(ActionEvent event) {
        if (validateForm()) {
            try {
                ...
                // Load step 2 form
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/competition_step2.fxml"));
                ...
                // Replace the current form with step 2 using Scene/Stage
                Scene scene = descriptionEditor.getScene();
                if (scene != null) {
                    Stage stage = (Stage) scene.getWindow();
                    stage.setScene(new Scene(step2Form));
                    stage.show();
                }
